    ...
    const fetchAddressDetails = async () => {
        try {
            ...
            if (data) {
                ...
                setLandmark(data.address_line2 || '');
                setCity(data.city);
                setState(data.state);
    ...
    return (
        <SafeAreaView style={{ flex: 1, backgroundColor: 'white' }}>
            ...
            <View style={{ flexDirection: 'row', alignItems: 'center', padding: 20, borderBottomWidth: 1, borderColor: '#f0f0f0' }}>
                ...
                <Text style={{ fontSize: 20, fontWeight: 'bold', marginLeft: 15 }}>{isEditMode ? 'Edit Address' : 'Add New Address'}</Text>
            </View>
                    ...
                    <ScrollView style={{ flex: 1 }} contentContainerStyle={{ padding: 20 }}>
                        ...
                        >
                            {loading ? (
                                ...
                                <Text style={{ color: 'white', fontWeight: 'bold', fontSize: 16 }}>{isEditMode ? 'UPDATE ADDRESS' : 'SAVE ADDRESS'}</Text>
                            )}
                        </TouchableOpacity>
