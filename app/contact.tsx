...
export default function Contact() {
    ...
    const contactMethods = [
        { icon: MessageCircle, label: 'WhatsApp', value: '+91 83293 20708', action: () => Linking.openURL('whatsapp://send?phone=918329320708&text=Hi, I have a query about my order'), color: '#25D366' },
        { icon: Phone, label: 'Call Us', value: '+91 83293 20708', action: () => Linking.openURL('tel:+918329320708'), color: '#007AFF' },
    ];
